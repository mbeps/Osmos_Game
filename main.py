...
if __name__=="__main__":
	...
	player: Player = Player(Vector(canvas_dimensions[0] / 2, canvas_dimensions[1] - 100), Vector(0, 0), 40)

	frame: simplegui.Frame = simplegui.create_frame("Domain", canvas_dimensions[0], canvas_dimensions[1])
	lines: list[Line] = [Line(Vector(0, 0), Vector(0, canvas_dimensions[1])), # Vertical 1
